  ...
  <section class="h-screen text-white">
    <div class="h-full">
      ...
      <div class="g-6 flex h-full flex-wrap items-center justify-center ">
        <div class="shrink-1 mb-12 grow-0 basis-auto md:mb-0 md:w-9/12 md:shrink-0 lg:w-6/12 flex items-center justify-center">
          <img src="https://tecdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.webp" class="w-4/5" alt="Sample image" />
        </div>
          ...
          <form>
            ...
            <div class="text-center lg:text-left">
              ...
              <p class="mb-0 mt-2 pt-1 text-sm font-semibold">
                ...
                <a href="#!" class="text-blue-500 transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700">Register</a>
              </p>
            </div>
          </form>
        </div>
